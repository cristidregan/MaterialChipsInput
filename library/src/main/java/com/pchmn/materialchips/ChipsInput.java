...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    ScrollViewMaxHeight mScrollView;
    // adapter
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mShowEditText = a.getBoolean(R.styleable.ChipsInput_show_edit_text, true);
                mBlockScroll = a.getBoolean(R.styleable.ChipsInput_block_scroll, false);
            } finally {
                a.recycle();
            }
        }
